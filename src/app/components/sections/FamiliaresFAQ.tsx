        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              Sabemos que a dependência química e os transtornos mentais afetam toda a família. Por isso, oferecemos um programa de apoio dedicado a orientar, acolher e fortalecer os laços familiares durante e após o tratamento.
            </p>
            <ul className="space-y-4 text-gray-600">
              <li className="flex items-start">
                <svg className="w-6 h-6 text-blue-500 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
          ...
          <div>
            ...
            <div className="space-y-4">
              {faqs.map((item, idx) => {
                ...
                return (
                  <div key={item.q} className="border rounded-lg bg-white">
                    <button

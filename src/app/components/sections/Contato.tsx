    ...
    <section id="contato" className="py-20 bg-gh-tertiary text-gh-hover">
      <div className="container mx-auto px-6">
        <div className="text-center">
          ...
          <p className="text-lg text-gh-hover max-w-3xl mx-auto mb-12">
            Nossa equipe está disponível 24 horas por dia para ouvir sua história e oferecer a ajuda que você precisa. O sigilo é absoluto.
          </p>
        </div>
        <div className="grid lg:grid-cols-2 gap-12">
          <form className="space-y-4">
            <div>
              ...
              <input
                ...
                name="nome"
                type="text"
                className="w-full p-3 rounded-lg bg-gh-secondary border border-gh-hover"
            ...
            <button
              type="submit"
              className="w-full bg-gh-hover text-gh-tertiary font-bold py-3 px-6 rounded-lg hover:bg-gh-primary transition duration-300"
            >
              Enviar Mensagem
            </button>
          </form>
          <div className="space-y-6">
            ...
            <div className="h-64 bg-blue-800 rounded-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.19757659551!2d-46.65657158440698!3d-23.56133926748434!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59c8da0aa315%3A0x2061596b5930a629!2sAv.%20Paulista%2C%20S%C3%A3o%20Paulo%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1678886543210!5m2!1spt-BR!2sbr"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                loading="lazy"
